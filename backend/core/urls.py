...
from .views import DemoBookingCreateView, ContactMessageCreateView, JobApplicationCreateView
...
urlpatterns = [
    ...
    path('job-applications/', JobApplicationCreateView.as_view(), name='platform-job-application'),
]
